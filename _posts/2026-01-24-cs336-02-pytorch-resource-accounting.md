---
title: "CS336 课程笔记 02：PyTorch 与资源估算"
date: 2026-01-24 16:37:39 +0800
last_modified_at: 2026-02-17 21:18:18 +0800
description: "CS336 课程笔记：训练资源估算、PyTorch 张量、FLOPs、优化器与混合精度。"
category: 课程笔记
series: Stanford CS336
series_slug: cs336
course_order: 2
course_label: Lecture 02
course_status: 完整记录
permalink: /courses/cs336/02-pytorch-resource-accounting/
tags: [LLM, PyTorch]
math: true
mermaid: false
...
- **float32**
![CS336 3.1 数据类型（图 1）](/assets/posts/cs336/lecture-02/lecture_02_1.png)

- **float16**
![CS336 3.1 数据类型（图 2）](/assets/posts/cs336/lecture-02/lecture_02_2.png)
float16因为指数位变少了的缘故，可能会在训练时发生下溢、上溢等等，造成训练不稳定

- **bfloat16**
![CS336 3.1 数据类型（图 3）](/assets/posts/cs336/lecture-02/lecture_02_3.png)

- **fp8**
![CS336 3.1 数据类型（图 4）](/assets/posts/cs336/lecture-02/lecture_02_4.png)
FP8有两种形式，E4M3和E5M2
...
![CS336 3.2.1 Operations（图 5）](/assets/posts/cs336/lecture-02/lecture_02_5.png)
