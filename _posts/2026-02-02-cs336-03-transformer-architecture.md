---
title: "CS336 课程笔记 03：Transformer 架构与变体"
date: 2026-02-02 21:44:49 +0800
last_modified_at: 2026-02-17 21:18:18 +0800
description: "CS336 课程笔记：Transformer、归一化、激活函数、位置编码与注意力变体。"
category: 课程笔记
series: Stanford CS336
series_slug: cs336
course_order: 3
course_label: Lecture 03
course_status: 完整记录
permalink: /courses/cs336/03-transformer-architecture/
...
标准transformer长这样：
![CS336 1.1 Standard Transformer（图 1）](/assets/posts/cs336/lecture-03/lecture_03_1.png)

### 1.2 Assignment 1 Version

作业一中实现的长这样：
![CS336 1.2 Assignment 1 Version（图 2）](/assets/posts/cs336/lecture-03/lecture_03_2.png)
...
![CS336 1.3.1.1 Pre-norm vs Post-norm（图 3）](/assets/posts/cs336/lecture-03/lecture_03_3.png)
...
![CS336 1.3.1.1 Pre-norm vs Post-norm（图 4）](/assets/posts/cs336/lecture-03/lecture_03_4.png)

##### 1.3.1.2 LayerNorm vs RMSNorm

现在很多模型使用RMSNorm，比如deepseek-V3等等，而不是最初transformer内的LayerNorm：
![CS336 1.3.1.2 LayerNorm vs RMSNorm（图 5）](/assets/posts/cs336/lecture-03/lecture_03_5.png)
...
![CS336 1.3.2.2 GeLU（Gaussian Error Linear Unit）（图 6）](/assets/posts/cs336/lecture-03/lecture_03_6.png)
...
![CS336 1.3.4.4.2 数学形式（图 7）](/assets/posts/cs336/lecture-03/lecture_03_7.png)
...
![CS336 1.3.5.1 FFN dim（图 8）](/assets/posts/cs336/lecture-03/lecture_03_8.png)

所以一般设置$d_{ff} = 4 d_{model}$，也有例外：[GLU](#1323-gated-activationsglu)一般设置为$d_{ff} = \frac{8}{3} d_{model}$
...
![CS336 1.3.5.2 num_heads, head_dim and model_dim（图 9）](/assets/posts/cs336/lecture-03/lecture_03_9.png)
...
![CS336 1.3.7.1 GQA/MQA（图 10）](/assets/posts/cs336/lecture-03/lecture_03_10.png)

##### 1.3.7.2 Sparse/Sliding Attention
